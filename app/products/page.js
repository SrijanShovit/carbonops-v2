  ...
  const products = [
    {
      ...
      description : "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Quos veritatis similique voluptate praesentium, unde exercitationem aut accusantium minima laborum aspernatur aliquam nobis vero, hic optio architecto sint minus tempore iste!",
      price : "$45"
    },
    {
      image : sampleImg,
  ...
  return (
    <div className='w-[95%] mx-auto mt-4'>
      ...
      <div className='w-[95%] mx-auto flex justify-center items-center mt-4 mb-8'>
        <h2 className='text-3xl sm:text-4xl text-[#53c6f2]'>Organization Name</h2>
      </div>
      <div>
        ...
        <div className='sm:flex-1 flex flex-col items-start justify-between text-center sm:text-left px-6 sm:px-0 gap-6'>
          <div>
            <h3 className='w-[22rem] sm:w-auto text-[#53c6f2] text-center text-2xl sm:text-3xl'>{product.productName}</h3>
          </div>
          <div>
        ...
        <div className='flex-1'>
          <div className='hidden sm:block'>
            <h2 className='sm:text-[#00BD57] text-xl py-2 font-bold'>DESCRIPTION</h2>
