        ...
        <section className="w-[70%] md:h-[calc(100%-200px)] mx-auto">
          <div className="flex justify-between items-start flex-row text-lg md:text-xl">
            ...
            <div className="justify-start">
              <div>
                ...
                </div>
                {
                  member && (
                    <div className="w-full flex justify-center items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 -z-20 rounded-lg ml-3">
                      <ul class="list-none">
                        <li>
                          <input type="checkbox" name="member-option" value="14" onChange={handleOptionChange} />
                          <label >you live alone</label></li>
                        <li>
                          <input type="checkbox" name="member-option" value="12" onChange={handleOptionChange} />
                          <label >you share a house or apartment with 1 other person</label></li>
                        <li>
                          <input type="checkbox" name="member-option" value="10" onChange={handleOptionChange} />
                          <label >you share a house or apartment with 2 other person</label></li>
                        <li>
                          <input type="checkbox" name="member-option" value="8" onChange={handleOptionChange} />
                          <label >you share a house or apartment with 3 other person</label></li>
                        <li>
                          <input type="checkbox" name="member-option" value="6" onChange={handleOptionChange} />
                          <label >you share a house or apartment with 4 other person</label></li>
                        <li>
                          <input type="checkbox" name="member-option" value="4" onChange={handleOptionChange} />
                          <label >you share a house or apartment with 5 other person</label></li>
                        <li>
                          <input type="checkbox" name="member-option" value="2" onChange={handleOptionChange} />
                ...
                </div>
                {
                  house && (<div className="w-full flex justify-center items-center bg-[#2d7d9f]  p-5 lg:p-7 rounded-lg ml-3">
                    <ul class="list-none">
                      <li>
                        <input type="checkbox" name="house-option" value="10" onChange={handleOptionChange} />
                        <label >you have a large house</label></li>
                      <li>
                        <input type="checkbox" name="house-option" value="7" onChange={handleOptionChange} />
                        <label >you have a medium-sized house</label></li>
                      <li>
                        <input type="checkbox" name="house-option" value="4" onChange={handleOptionChange} />
                        <label >you have a small-sized house</label></li>
                      <li>
                        <input type="checkbox" name="house-option" value="2" onChange={handleOptionChange} />
                ...
                </div>
                {
                  diet && (<div className="w-full flex justify-center items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 ml-3 -z-20 rounded-lg">
                    <ul class="list-none">
                      <li>
                        <input type="checkbox" name="diet-option" value="10" onChange={handleOptionChange} />
                        <label >you eat domestic meat on a daily basis</label></li>
                      <li>
                        <input type="checkbox" name="diet-option" value="8" onChange={handleOptionChange} />
                        <label >you eat domestic meat a few times per week</label></li>
                      <li>
                        <input type="checkbox" name="diet-option" value="4" onChange={handleOptionChange} />
                        <label >you are a vegetarian</label></li>
                      <li>
                        <input type="checkbox" name="diet-option" value="2" onChange={handleOptionChange} />
                ...
                </div>
                {
                  pack && (<div className="w-full flex justify-start items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 ml-3 -z-20 rounded-lg">
                    <ul class="list-none">
                      <li>
                        <input type="checkbox" name="pack-option" value="12" onChange={handleOptionChange} />
                        <label >most of the food you eat is prepackaged convenience food, such as frozen pizza, cereal, and potato chips</label></li>
                      <li>
                        <input type="checkbox" name="pack-option" value="6" onChange={handleOptionChange} />
                ...
                {dish && <div className="w-full flex justify-start items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 ml-3 -z-20 rounded-lg">
                  <ul class="list-none">
                    <li>
                      <input type="checkbox" name="dish-option" value="3" onChange={handleOptionChange} />
                      <label >you run it more than 9 times per week</label></li>
                    <li>
                      <input type="checkbox" name="dish-option" value="2" onChange={handleOptionChange} />
                      <label >you run it 4 to 9 times</label></li>
                    <li>
                      <input type="checkbox" name="dish-option" value="1" onChange={handleOptionChange} />
                ...
                </div>
                {
                  purchase && (<div className="w-full flex justify-center items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 ml-3 -z-20 rounded-lg">
                    <ul class="list-none">
                      <li>
                        <input type="checkbox" name="purchase-option" value="10" onChange={handleOptionChange} />
                        <label >you buy more than 7 new pieces of furniture, electronics, or other household gadgets per year</label></li>
                      <li>
                        <input type="checkbox" name="purchase-option" value="8" onChange={handleOptionChange} />
                        <label >you purchase between 5 and 7 items</label></li>
                      <li>
                        <input type="checkbox" name="purchase-option" value="6" onChange={handleOptionChange} />
                        <label >you purchase between 3 and 5 items</label></li>
                      <li>
                        <input type="checkbox" name="purchase-option" value="4" onChange={handleOptionChange} />
                        <label >you purchase less than 3 items</label></li>
                      <li>
                        <input type="checkbox" name="purchase-option" value="2" onChange={handleOptionChange} />
                ...
                {machine && <div className="w-full flex justify-start items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 ml-3 -z-20 rounded-lg">
                  <ul class="list-none">
                    <li>
                      <input type="checkbox" name="machine-option" value="3" onChange={handleOptionChange} />
                      <label >you run it more than 9 times per week</label></li>
                    <li>
                      <input type="checkbox" name="machine-option" value="2" onChange={handleOptionChange} />
                      <label >you run it 4 to 9 times</label></li>
                    <li>
                      <input type="checkbox" name="machine-option" value="1" onChange={handleOptionChange} />
                      <label >you run it 1 to 3 times</label></li>
                  </ul>
                </div>}
                {/* 8 */}
                ...
                </div>
                {
                  cans && (<div className="w-full flex justify-center items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 ml-3 -z-20 rounded-lg">
                    <ul class="list-none">
                      <li>
                        <input type="checkbox" name="cans-option" value="50" onChange={handleOptionChange} />
                        <label >you fill 4 garbage cans each week</label></li>
                      <li>
                        <input type="checkbox" name="cans-option" value="40" onChange={handleOptionChange} />
                        <label >you fill 3 garbage cans each week</label></li>
                      <li>
                        <input type="checkbox" name="cans-option" value="30" onChange={handleOptionChange} />
                        <label >you fill 2 garbage cans per week</label></li>
                      <li>
                        <input type="checkbox" name="cans-option" value="20" onChange={handleOptionChange} />
                        <label >you fill 1 garbage can per week</label></li>
                      <li>
                        <input type="checkbox" name="cans-option" value="5" onChange={handleOptionChange} />
                ...
                </div>
                {
                  flight && (<div className="w-full flex justify-center items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 ml-3 -z-20 rounded-lg">
                    <ul class="list-none">
                      <li>
                        <input type="checkbox" name="flight-option" value="2" onChange={handleOptionChange} />
                        <label >you only travel short distances in 1 year, such as within your state</label></li>
                      <li>
                        <input type="checkbox" name="flight-option" value="6" onChange={handleOptionChange} />
                        <label >you travel further distances, such as to a nearby state or country</label></li>
                      <li>
                        <input type="checkbox" name="flight-option" value="20" onChange={handleOptionChange} />
                ...
                </div>
                {
                  personal && (<div className="w-full flex justify-center items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 ml-3 -z-20 rounded-lg">
                    <ul class="list-none">
                      <li>
                        <input type="checkbox" name="cans-option" value="12" onChange={handleOptionChange} />
                        <label >you travel more than 15,000 miles per year</label></li>
                      <li>
                        <input type="checkbox" name="cans-option" value="10" onChange={handleOptionChange} />
                        <label >you travel 10,000 to 15,000 miles per year</label></li>
                      <li>
                        <input type="checkbox" name="cans-option" value="6" onChange={handleOptionChange} />
                        <label >you travel 1,000 to 10,000 miles per year</label></li>
                      <li>
                        <input type="checkbox" name="cans-option" value="4" onChange={handleOptionChange} />
                        <label >you travel less than 1,000 miles per year</label></li>
                      <li>
                        <input type="checkbox" name="cans-option" value="0" onChange={handleOptionChange} />
              ...
              </div>
              {
                publict && (
                  <div className="w-full flex justify-center items-center bg-[#2d7d9f] mx-auto p-5 lg:p-7 -z-20 ml-3 rounded-lg">
                    ...
                    <ul class="list-none">
                      <li>
                        <input type="checkbox" name="publict-option" value="12" onChange={handleOptionChange} />
                        <label >you travel more than 20,000 miles per year</label></li>
                      <li>
                        <input type="checkbox" name="publict-option" value="10" onChange={handleOptionChange} />
                        <label >you travel 15,000 to 20,000 miles per year</label></li>
                      <li>
                        <input type="checkbox" name="publict-option" value="6" onChange={handleOptionChange} />
                        <label >you travel 10,000 to 15,000 miles per year</label></li>
                      <li>
                        <input type="checkbox" name="publict-option" value="4" onChange={handleOptionChange} />
                        <label >you travel 1,000 to 10,000 miles per year</label></li>
                      <li>
                        <input type="checkbox" name="publict-option" value="2" onChange={handleOptionChange} />
                        <label >less than 1,000 miles per year</label></li>
                      <li>
                        <input type="checkbox" name="publict-option" value="0" onChange={handleOptionChange} />
              ...
              {isDone && (
                <button className="text-lg md:text-xl bg-[#00BD57] py-0 md:py-1 px-4 md:px-auto rounded-tl-xl rounded-br-xl rounded-tr-sm rounded-bl-sm hover:shadow-md hover:shadow-green-300 duration-200 ease-out m-8" onClick={checkDone}>
              ...
              >
                <div className="score-modal-content">
                  <div className="text-lg py-4 text-center" style={{ color: 'white' }}>
                    Your Score

                    <div
                      className="w-24 h-24 rounded-full border-8 border-[#00bd57] flex justify-center items-center"

                    >
                      {score}

                    </div>
                    <button onClick={closeModal} className="text-lg mt-4">
                      Close
                    </button>
                  </div>
                </div>
